from .tables import Artifact, Client, ClientApp, ClientEvent, ClientToken, Setting, Job, ClientJobEvent, Model
...
def init_content(db: Session) -> None:
    ...
    ClientJobEvent.__table__.create(bind=engine, checkfirst=True)
